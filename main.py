...
BG = pygame.transform.scale(pygame.image.load(os.path.join('Assets', 'space.png')),(WIN_WIDTH,WIN_HEIGHT))
...
def yellow_handle_movemet(keys_pressed,yellow):
    ...
    if keys_pressed[pygame.K_w] and yellow.y - VEL > 0: #UP
        yellow.y -= VEL
    if keys_pressed[pygame.K_s]and yellow.y + VEL + yellow.height <WIN_HEIGHT - 15: #DOWN
        yellow.y += VEL

def red_handle_movemet(keys_pressed,red):
    ...
    if keys_pressed[pygame.K_UP] and red.y - VEL > 0: #UP
        red.y -= VEL
    if keys_pressed[pygame.K_DOWN]and red.y + VEL + red.height <WIN_HEIGHT - 15: #DOWN
        red.y += VEL
...
def main():
    ...
    while run:
        ...
        yellow_handle_movemet(keys_pressed,yellow)
        red_handle_movemet(keys_pressed, red)
